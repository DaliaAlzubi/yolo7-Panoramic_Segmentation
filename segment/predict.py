        ...
        for i, det in enumerate(pred):  # per image
            ...
            if save_img:
                if dataset.mode == 'image':
                    cv2.putText(im0, '-- Caries', (50, 50 + (0*40)), 0, 1, [56, 56, 255], thickness=2, lineType=cv2.LINE_AA)
                    cv2.putText(im0, '-- Crowns', (50, 50 + (1*40)), 0, 1, [151, 157, 255], thickness=2, lineType=cv2.LINE_AA)
                    cv2.putText(im0, '-- Root Canal Obturation', (50, 50 + (2*40)), 0, 1, [49, 210, 207], thickness=2, lineType=cv2.LINE_AA)
                    cv2.putText(im0, '-- Fillings', (50, 50 + (3*40)), 0, 1, [31, 112, 255], thickness=2, lineType=cv2.LINE_AA)
                    cv2.putText(im0, '-- Implants', (50, 50 + (4*40)), 0, 1, [29, 178, 255], thickness=2, lineType=cv2.LINE_AA)
                    # cv2.putText(im0, 'Dr. Dalia Al-Zoubi', (50, 50 + (im0.shape[1]-80)), 0, 1, [29, 178, 255], thickness=2, lineType=cv2.LINE_AA)
